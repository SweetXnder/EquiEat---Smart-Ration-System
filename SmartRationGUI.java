 ...
 * Features:
 * 1. Equitable Rationing System
 * 2. Digests CSV/EXCEL Imports As Data
 * 3. User-Input Ration Prioritization
 * 4. HTML Stub Generator, HTML Final Ration Table
 * 5. Audit Logging
 */
...
public class SmartRationGUI extends JFrame { // Creates our GUI/Window
    ...
    public SmartRationGUI() {
        ...
        // Center-aligned the header text for better layout
    ...
    private List<Family> importCSV(String filePath) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            line = line.replace("\uFEFF", ""); //some excel starts with a character even when empty
            // replace them with an empty space
            String delimiter = line.contains(";") ? ";" : ","; //delimits to what the excel formats is so we can then make a csv file
            String[] headers = line.split(delimiter);

            
            // Column Header Finder, Not pre-fixed so we can handle bad data.
    ...
    private void runDistribution(JTabbedPane tabs) {
        ...
        // 2. Run Engine (Updated to Whole Numbers As Per Our Professor)
    ...
    private void exportResults() {
        try {
            // MERGED: Use .html extension for the packing list
            ...
            // MERGED: Update log to reflect HTML generation
            logger.log("EXPORT", "Files generated: HTML, TXT, HTML.");

            // MERGED: Update success message
    ...
    public static class ReportGenerator {
        // MERGED: Modified to generate HTML file
